...
{
        [Serializable]
                public class CPng : CPicture
                {
                        static string s_sTypeIdentifier = "PNG Image File";
                        static string s_sPlayer = "gqview";
                        static string s_sExtension = ".png";
                        static string s_sDescription="This type handle all PNG image file.\nComment? Suggestion? root@dev-fr.com";

                        public CPng(): this("")
                        {
                        }
                        public CPng(string fullName)
                        {
                                Path = fullName;
                                DimensionsX = 0;
                                DimensionsY = 0;
                        ...
                        public override Gtk.Widget Display
                        {
                                get 
                                {
                                        ...
                                        try
                                        {
                                                Glade.XML m_displayXML = new Glade.XML(null,"cpng.glade","ShowWindow",null);
                                        ...
                                        {
                                                Console.WriteLine("CPng Display: "+e.Message);
                                        }
                                        return null;
                                }
                        }
                        public override Gtk.Widget Edit
                        {
                                get 
                                {
                                        try
                                        {
                                                Glade.XML m_displayXML = new Glade.XML(null,"cpng.glade","EditWindow",null);
                                                m_displayXML.Autoconnect(this);
                                        ...
                                        {
                                                Console.WriteLine("CPng Edit: "+e.Message);
                                        }
                                        return null;
                                }
                                set {}
                        ...
                        public void OnShowButton(object o, EventArgs args)
                        {
                                try
                                {
                                        Glade.XML m_displayXML = new Glade.XML(null,"cpng.glade","FullscreenWindow",null);
                                        m_displayXML.Autoconnect(this);
                                ...
                                {
                                        Console.WriteLine("CPng Fullscreen aborted: "+e.Message);
                                }
                        }
